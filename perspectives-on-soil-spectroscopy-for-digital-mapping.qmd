...
![Differences between the maps](fig/maps-calibration-set-sizes.png){fig-align="center"}
...
#| fig-height: 3
library(qrcode)
plot(qr_code("https://l-ramirez-lopez.github.io/fbas-2026/"))
```
...
#| label: qr-code
library(qrcode)
my_qr <- qr_code("https://l-ramirez-lopez.github.io/fbas-2026/")
plot(my_qr)
```
